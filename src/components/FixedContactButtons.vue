...
<template>
    <div
        ...
        class="b24-widget-button-shadow"
    ...
    >
        ...
        <div id="sudovn-btn-social">
            <a
                ...
                <div class="sudovn-btn-social-item-label">{{ formatPhone(phone) }}</div></a
            ><a
                ...
                <div class="sudovn-btn-social-item-label">{{ formatPhone(zalo) }}</div></a
            ><a
                :href="'https://m.me/profile.php?id=' + fbId"
                target="_blank"
                rel="nofollow"
                class="sudovn-btn-social-item"
                ><div class="sudovn-btn-social-item-icon">
                ...
                <div class="sudovn-btn-social-item-label">
                    Dược Liệu Việt Hưng
                </div></a
            >
            <!-- <div class="sudovn-credit">
                Powered by
                <a href="https://nguyencaotu.com" target="_blank" rel="nofollow"
                    >Tú Cao</a
                >
            </div> -->
        </div>
